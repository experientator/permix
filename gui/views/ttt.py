...
class CompositionView(tk.Frame):
    ...
    def create_template_frame(self):
        ...
        data_type = ["", "экспериментальные", "теоретические", "расчетные"]
        device_type = []
        ...
        self.mi_label4 = tk.Label(self.main_info_frame,
                                  text="doi",
                                  **AppStyles.label_style())
        self.mi_label4.grid(row=1, column=0, sticky='ew', padx=5, pady=2)
        ...
        self.mi_label5 = tk.Label(self.main_info_frame,
                                  text="doi",
                                  **AppStyles.label_style())
        self.mi_label5.grid(row=1, column=1, sticky='ew', padx=5, pady=2)
        ...
        self.button_info_entry = tk.Button(self.submit_button_frame,
                                           text = "Подтвердить основную информацию",
    ...
    def create_properties_frame(self, device_type):
        ...
        for row in range(num_properties):
            ...
            label = tk.Label(self.properties_frame, text=label_text, **AppStyles.entry_style())
